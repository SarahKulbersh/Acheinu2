...
export const SignIn = () => {
    ...
    const [isEmployee, setIsEmployee] = useState(sessionStorage.getItem("locationBeforeSignIn") !== '/post');
            ...
            <div className='job_portal_signin'>
                <div className='signin_box'>
                    ...
                    <div className='sinin_form_field'>
                        ...
                        <div className='singup_link'>Don’t have an account? <Link to='/signup'>Sign Up</Link></div>
                    </div>
                </div>
            </div>
            <Footer />
